...
class CapsNet(nn.Module):
    ...
    Args:
        ...
        ...
    """
    def __init__(self, in_features, out_features, A=8, B=8, C=8, D=8, E=10, K=3, P=4, iters=3):
        super(CapsNet, self).__init__()
        self.conv1 = nn.Conv2d(in_channels=in_features, out_channels=A,
        ...
        self.class_caps = ConvCaps(D, out_features, 1, P, stride=1, iters=iters,
